...
static struct task_struct *speedchange_task1;
...
static int __init cpufreq_thunderstorm_init(void)
{
	...
	sched_setscheduler_nocheck(speedchange_task1, SCHED_FIFO, &param);
	get_task_struct(speedchange_task1);
...
static void __exit cpufreq_thunderstorm_exit(void)
{
	...
	kthread_stop(speedchange_task1);
	put_task_struct(speedchange_task1);
}
